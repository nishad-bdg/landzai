      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <VueSlickCarousel v-bind="settings" class="">
            <div class="product-priview-slide">
              <a
                href="assets/images/products/single-product-image.png"
                data-fancybox="gallery"
              >
                <img
                  class="product-image"
                  src="assets/images/products/single-product-image.png"
                  alt="image-1"
                />
              </a>
              <!-- <a
          ...
          <VueSlickCarousel
            v-bind="settingsThumbnail"
            class="product-thumbnail-image"
          >
            <ul class="product-thumb-silide">
              <li>
                <img
                  src="assets/images/products/single-product-image-thumbnail.png"
                  alt="cart"
                />
              </li>
              <!-- <li>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="product-info">
            <h2 class="product-title">men Black T-shirt</h2>
            <div class="price-box">
            ...
            <div class="product-description">
              ...
              <p>
                Natoque nec, accumsan, aliquam est diam pellentesque tellus et.
                Convallis sem scelerisque lectus dolor bibendum. Vitae quam
                vestibulum ornare phasellus id egestas. Nisl quis nibh tristique
                et. Aliquet commodo at malesuada lectus adipiscing elementum
                ultricies.
              </p>
            </div>
            ...
            <div class="product-color-area">
              ...
              <ul class="color-list">
                ...
                <li class="active">
                  <a href="#" style="background: #ff6c5a"></a>
                </li>
