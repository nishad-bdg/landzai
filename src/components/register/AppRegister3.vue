<template>
  ...
  <section class="register-area-v3 section-top">
    <div class="container">
      <div class="row no-gutters section-backgroun">
              ...
              >
                <div class="register-wrap">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            />
                            <span
                              class="fa fa-fw fa-eye icon toggle-password"
                            ></span>
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group">
                            <input
                              ...
                              id="sign_up_repassword"
                              name="sign_up_repassword"
                              placeholder="Retype Password"
                            />
                            <span
                              class="fa fa-fw fa-eye icon toggle-repassword"
                            ></span>
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group form-check">
                            <input
                              ...
                              id="sign_up_check"
                            />
                            <label class="form-check-label" for="sign_up_check"
                              >By Creating an account you to the
                              <a href="#">terms of use</a> our
                  ...
                  <div class="tab-register text-center">
                    ...
                    <a class="google-regiter" href="#">
                      <img src="assets/images/gogole-icon.png" alt="gogole-icon" />
        ...
        <div class="col-lg-6 align-self-center">
          <div class="register-info text-center">
            <img src="assets/images/register-v3-iamge.png" alt="registeriamge" />
          </div>
        </div>
      </div>
    </div>
